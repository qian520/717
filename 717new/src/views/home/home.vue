            ...
            <div class="main-wrap">
                ...
                <div class="icon-lists">
                    <div class="icon-lists-top">
                        <dl>
                            <dt style="background: #47D265"><img src="../../imgs/home-list01.png" alt=""></dt>
                            <dd> 家乡味道</dd>
                        </dl>
                        <dl>
                            <dt style="background: #FF7902"><img src="../../imgs/home-list02.png" alt=""></dt>
                            <dd>进口食品</dd>
                        </dl>
                        <dl>
                            <dt style="background: #5BAAFF"><img src="../../imgs/home-list03.png" alt=""></dt>
                            <dd>牛奶乳品</dd>
                        </dl>
                        <dl>
                            <dt style="background: #FFB447"><img src="../../imgs/home-list04.png" alt=""></dt>
                            <dd>茶果冲引</dd>
                        </dl>
                    </div>
                    <div class="icon-lists-bot">
                        <dl>
                            <dt style="background: #FF655B"><img src="../../imgs/home-list05.png" alt=""></dt>
                            <dd>休闲零食</dd>
                        </dl>
                        <dl>
                            <dt style="background: #67CCFF"><img src="../../imgs/home-list06.png" alt=""></dt>
                            <dd>米面粮油</dd>
                        </dl>
                        <dl>
                            <dt style="background: #FFD33C">                        
                            <img src="../../imgs/home-list07.png" alt=""></dt>
                            <dd>调味调料</dd>
                        </dl>
                        <dl>
                            <dt style="background: #5BDCC8"><img src="../../imgs/home-list08.png" alt=""></dt>
                            <dd>酒水新料</dd>
                        </dl>
                    </div>
                </div>
